...
# x = y1 + y2
# x = e^t + 5e^2t
# ×' = e^t + 2 * 10 * e^2t = = e^t + 20 * e^2t
# e^t = z
# × = z + 5z^2
# ×' = z + 2z^2


z, x, xp, C = symbols('z x xp, C')

# Define the equations
eqs = [x - (z + 10 * z**2), xp - (z + 2 * 10 * z**2)]
...
def evaluate_original_equations(z_val):
    x_val = z_val + 10 *z_val**2
    xp_val = z_val + 20 * z_val**2
    return x_val, xp_val
...
df.to_csv("data65.csv", index=False)